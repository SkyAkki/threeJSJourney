...
parameters.outsideColor = '#ff3984'
...
const generateGalaxy = () => {
    ...
    if(points !== null){
        geometry.dispose()
        material.dispose()
        //No such thing as mesh in memory as its a combination of geometry and material
        scene.remove(points)
    }
...
gui.add(parameters, 'branches').min(3).max(7).step(1).onFinishChange(generateGalaxy)
